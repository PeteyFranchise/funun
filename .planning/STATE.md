...
status: pending
stopped_at: "Phase 27 waves 1-4 SHIPPED (10/11 plans on main, full suite green, /signup gate + /unsubscribe live-verified). Independent Codex review (27-CODEX-REVIEW.md) found 3 blockers + 2 high + 8 medium + 3 low pre-cutover; DB-gate findings B1/M1/M2/M3/M4/L1 fixed via migration 099 (fix-forward, 098 left unedited) + allowlist.ts/test updates + break-glass docs — 162 suites/1905 tests, tsc, lint, build all clean; migration 099 is TEXT/TEST-ONLY, not pushed. B2 (unsubscribe never set unsubscribed_at) fixed via a new token-authenticated POST /api/waitlist/unsubscribe (mirrors resubscribe/route.ts, IDOR-safe, idempotent) + the unsubscribe page now calling it on load and confirming only after success — 163 suites/1912 tests, tsc, lint, build all clean; no migration involved, no DB push needed. B3/H1/H2/M5/M6/L2/L3 (non-DB-gate findings: broadcast invite-minting, expired-invite reissue, waitlist error handling, collaborator-invite HTML escaping, enumeration/rate-limit) remain OPEN, not yet fixed. NEXT = Wave 5 owner cutover (27-11): (1) resolve remaining review findings (B3/H1/H2/M5/M6), (2) confirm/seed owner bootstrap artist account, (3) provision Cloudflare Turnstile keys, (4) sign off 3 email templates, (5) [BLOCKING] supabase db push migrations 097+098+099 together (flips gate LIVE — 098 alone re-introduces B1), (6) smoke test. Migrations NOT yet pushed; gate NOT live. Then /gsd-docs-update to register INVITE-01..12, then /gsd-verify-work + /gsd-ship."
last_updated: "2026-08-09T10:15:00.000Z"
