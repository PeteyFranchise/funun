...
- Added migration 059 so shared databases that already applied migration 057 receive the corrected visibility helper.
...
- Migration 059 must be pushed/applied to the target Supabase database before the database-level privacy fix is live.
