...
number: 1
name: Completion persistence round-trip (LAUNCH-04)
expected: |
  Check an item on /launchpad/[projectId], then hard-reload — item stays checked.
  Uncheck it, reload again — it stays unchecked.
