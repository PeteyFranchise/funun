...
- [x] **SOCIAL-03**: AI generates a 4–6 week content calendar from release data (title, genre, collaborators, release date, story); calendar is structured by week and platform
...
- [x] **SOCIAL-05**: DropReady and SoundBait are accessible as inline calendar slot actions ("Generate caption", "Generate hook") and as standalone quick tools in the Launchpad tools view
- [x] **SOCIAL-06**: Artist can check off calendar posts as they go live; completion is tracked per project
- [x] **SOCIAL-07**: Artist can export the campaign calendar as a Buffer-compatible CSV (columns: Text, Image URL, Tags, Posting Time)
