...
A Funūn A&R is responsible for the continuity of the creative relationship—from discovery
through development, readiness, opportunity and follow-through.

The A&R learns what a creator is trying to build before recommending what should happen
next. They combine creative judgment, relationship stewardship, catalogue awareness,
business readiness and dependable follow-through without taking ownership of the creator's
voice or promising outcomes outside their authority.

## Point 1 — Core responsibilities

### Discovery and cultural awareness
...
- Avoid allowing follower counts, streaming totals, personal taste or industry hype to become the only measures of potential.
...
### Onboarding and platform guidance
...
### Project and catalogue awareness
...
### Opportunity development and matching
...
### Internal AE partnership and opportunity circulation
...
- Learn from AEs what each opportunity actually requires—including creative fit, business constraints, rights readiness, deadlines and the status of the opportunity—before sharing it.
...
This responsibility establishes the A&R as the internal bridge between Funūn's opportunity
pipeline and its creative network. Reach should be broad but relevance must remain real.
Access to an opportunity is not a promise of selection, placement or compensation.
...
### Member advocacy and accountability
...
### Safety, privacy and professional conduct
...
The eventual A&R console must make it possible to:

- Maintain creator, project and catalogue context without duplicating records.
- See upcoming AE-owned opportunities and their precise matching requirements.
- Search and compare all relevant, permissioned network matches—not only an assigned roster.
- Record consideration, distribution, submissions, feedback, outcomes and follow-up.
- Distinguish internal notes, creator-visible communication and confidential client context.
- Preserve fair discovery by showing who has and has not received relevant opportunities.
- Carry useful feedback from AEs and opportunity outcomes back into catalogue knowledge.

These are product implications, not a final screen design or authorization model.

## Remaining doctrine discussion

1. Decision authority and Leadership approval boundaries.
2. Daily workflow and highest-frequency actions.
3. Artist, release, submission and conversation access scope.
4. Onboarding and roster-management process.
5. Listening, evaluation, feedback and follow-up workflow.
6. Internal notes versus artist-visible communication.
7. Tasks, reminders, call logs and reusable gameplans.
8. Escalations to Leadership, Legal, Sync and other teams.
9. Useful metrics and anti-gaming safeguards.
10. Privacy, permissions, audit history and conflict boundaries.
11. Mobile listening and response needs.
12. Beta scope versus later capability.
