...
| **201–202** | Playbook rich-content model R1 (Codex) | **CANDIDATE, unapplied.** `.planning/quick/260907-playbook-doctrine-publication-uat/`. Drafted outside `supabase/migrations/` by design. |
