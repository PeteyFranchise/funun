...
- [ ] 22-01-PLAN.md — Record the built slices 1/2a/2b (faithful light catalogue + filters/search/sort + player/modal over the fixture); no new code, honest baseline. [catalogue-browse, audio-player]
