...
| **214** | Verified invitation claim hardening (Codex) | **LOCAL CANDIDATE — HUMAN-GATED, NOT APPLIED.** Requires coordinated Supabase email-confirmation settings and application rollout. |
