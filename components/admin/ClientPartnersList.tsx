...
// never a filled dot, never a duplicate of the green "good" state. Slice 1
// has no health computation yet (31.1), so every row renders this until
// then — a placeholder render slot, not a fake positive signal.
...
function renderCell(row: ClientPartnerRow, col: ColumnDef, mode: ClientPartnersListMode) {
  switch (col.key) {
    case 'name':
