...
.fncon{--ground:#0a0a0f;--panel:#0E0D1E;--panel-2:#1A1838;--ink:#FFFFFF;--ink-2:#C7CBF7;--ink-3:#7c80b4;--border:rgba(199,203,247,.12);--border-2:rgba(199,203,247,.22);--indigo:#818CF8;--fuchsia:#D946EF;--grad:linear-gradient(105deg,#818CF8 0%,#D946EF 100%);--green-fg:#34D399;--green-bg:rgba(52,211,153,.11);--green-line:rgba(52,211,153,.3);--amber-fg:#F4C77B;--amber-bg:rgba(245,158,11,.11);--amber-line:rgba(245,158,11,.3);--rose-fg:#F9A8C0;--rose-bg:rgba(244,63,94,.1);--rose-line:rgba(244,63,94,.3);--r-lead:#818CF8;--r-ae:#34D399;--r-bd:#F59E0B;--r-anr:#D946EF;--r-legal:#FB7185;--r-it:#38BDF8;--r-tms:#2DD4BF;background:var(--ground);color:var(--ink);min-height:100vh;}
