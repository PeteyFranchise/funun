        ...
        {sent
          ? (
            <div className="bb-sent" role="status">
              ...
              <span>Your brief&rsquo;s ready. Sending it straight to an AE lands in the next release — for now, hit <b>See matches in The Crate</b> and start digging.</span>
            </div>
          )
          : <span className="bb-note">Nothing is charged here — a brief starts a conversation with your AE.</span>}
        <div className="bb-actions">
          <button type="button" className="bb-secondary" onClick={() => setSent(true)}>Send to my AE</button>
