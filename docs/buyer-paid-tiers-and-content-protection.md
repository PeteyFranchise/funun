> **Team reference** — Phase 24 buyer self-serve: paid-tier models + content protection (compiled 2026-08-10).
> Planning-scoped original: `.planning/phases/24-buyer-onboarding-self-serve/24-RESEARCH-paid-tiers.md`. Keep the two in sync if edited. A shareable PDF of this exists too.
