...
export async function POST(request: Request, { params }: RouteCtx) {
  ...
  // whole metadata object and writing it back meant a concurrent instrumental
  // write silently erased this stems key (or the reverse) — the file survived
...
export async function DELETE(_request: Request, { params }: RouteCtx) {
  ...
  if (stemsPath && stemsPath.startsWith(expectedPrefix) && !stemsPath.includes('..')) {
