...
export const PLAYBOOK_PUBLICATION_MANIFEST: PublicationManifestItem[] = [
  ...
  { key: 'legal-leadership-doctrine', title: 'Legal Leadership and Roles Doctrine', sourcePath: '.planning/deliberations/organizational-doctrine/legal-leadership-and-roles-doctrine.md', roomKey: 'rights-legal', subgroupKey: 'role-doctrine', reviewerRoles: ['legal', 'leadership'], gamePlanKeys: [], supersedesTitles: [] },
  ...
  { key: 'member-workspace-doctrine', title: 'Member Workspaces — Identity, Authority and Custody', sourcePath: '.planning/deliberations/member-workspaces/member-workspaces-doctrine.md#member-workspaces-identity-authority-and-custody-doctrine', roomKey: 'company-wide', subgroupKey: 'organizational-doctrine', reviewerRoles: ['anr', 'ae', 'legal', 'leadership'], gamePlanKeys: [], supersedesTitles: [] },
  { key: 'member-workspace-ar-sales', title: 'A&R and Sales — Working Through Member Workspaces', sourcePath: '.planning/deliberations/member-workspaces/member-workspaces-doctrine.md#a-r-and-sales-working-through-member-workspaces', roomKey: 'company-wide', subgroupKey: 'cross-functional-operations', reviewerRoles: ['anr', 'ae', 'leadership'], gamePlanKeys: [], supersedesTitles: [] },
  { key: 'member-workspace-it-controls', title: 'IT and Leadership — Workspace Rollout and Incident Controls', sourcePath: '.planning/deliberations/member-workspaces/member-workspaces-doctrine.md#it-and-leadership-workspace-rollout-and-incident-controls', roomKey: 'it-team', subgroupKey: 'role-doctrine', reviewerRoles: ['it', 'leadership'], gamePlanKeys: ['incident-response'], supersedesTitles: [] },
]
