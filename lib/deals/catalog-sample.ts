...
// Every row carries one of the TWO buyer-facing rights states — 'ok' or 'req'.
// This fixture is the PUBLIC empty-state fallback on /sync and /sync/catalog,
// so a row here is a row a real buyer sees. 'part' was removed (s4 → 'ok',
// s8 → 'req'): the catalogue entry gate makes it unreachable for a buyer, the
// help page no longer defines it, and the Rights filter no longer offers it,
// so a 'part' fixture row would show a badge with no definition behind it and
// disappear the moment any Rights filter was applied.
...
export const SAMPLE_CATALOG_ROWS: CatalogRow[] = [
  ...
  { id: 's4', title: 'Golden Hour', artist: 'Ledger & Vine', coverUrl: '/buyer-catalogue/golden-hour.jpg', gradient: GRADIENTS[4], genres: 'Soul, Pop', energy: 'Low-Medium', length: '4:11', versions: 1, rights: 'ok', dynamics: 'twin', mood: 'Warm', vocal: 'Vocal', instruments: ['Guitar', 'Piano'], vaultProjectId: 's4', tracks: [{ id: 's4-t1', title: 'Golden Hour' }] },
  ...
  { id: 's8', title: 'Brass Season', artist: 'Ilo Marchetti', coverUrl: null, gradient: GRADIENTS[4], genres: 'Jazz, Cinematic', energy: 'High', length: '2:48', versions: 2, rights: 'req', dynamics: 'peak', mood: 'Warm', vocal: 'Instrumental', instruments: ['Brass', 'Piano'], vaultProjectId: 's8', tracks: [{ id: 's8-t1', title: 'Brass Season' }] },
]
